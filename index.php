          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-md-4 col-12">
                <div class="about-img"> 
                  <br>
                  <img src="products/p1.jpg" alt="img-fluid">
                </div> 
            ...
            <div class="row">
                ...
                <div class="card  text-center bg-white pb-2 ">
                  <div class="card-body text-dark">
                    <div class="img-area mb-4">
                     <img src="products/p1.jpg" alt="" class="img-fluid">
                    </div>
                    <h3 class="card-title">Best Electronics</h3>
              ...
              <div class="col-12 col-md-12 col-lg-4">
                <div class="card  text-center bg-white pb-2 ">
                  <div class="card-body text-dark">
                    <div class="img-area mb-4">
                     <img src="products/fashion.jpg" alt="" class="img-fluid">
                    </div>
                    <h3 class="card-title">Best Schools</h3>
              ...
              <div class="col-12 col-md-12 col-lg-4">
                <div class="card  text-center bg-white pb-2 ">
                  <div class="card-body text-dark">
                    <div class="img-area mb-4">
                     <img src="products/perfumes.jpg" alt="" class="img-fluid" >
                    </div>
                    <h3 class="card-title">Best Schools</h3>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-3">
                <div class="card text-center">
                  <div class="card-body">
                    <img src="products/herbels.jpg" alt="" class="img-fluid rounded-circle">
                    <h3 class="card-title py-2">Herbels</h3>
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="card text-center">
                  <div class="card-body">
                    <img src="products/p4.jpg" alt="" class="img-fluid rounded-circle">
                    <h3 class="card-title py-2">Cosmetics</h3>
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique odit consequatur architecto accusamus incidunt consequuntur maxime nemo rerum  </p>
                    <p class="socials">
                      <i class="bi bi-twitter text-dark mx-1"></i>
                      <i class="bi bi-facebook text-dark mx-1"></i>
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="card text-center">
                  <div class="card-body">
                    <img src="products/perfumes.jpg" alt="" class="img-fluid rounded-circle">
                    <h3 class="card-title py-2">Perfumes</h3>
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique odit consequatur architecto accusamus incidunt consequuntur maxime nemo rerum  </p>
                    <p class="socials">
                      <i class="bi bi-twitter text-dark mx-1"></i>
                      <i class="bi bi-facebook text-dark mx-1"></i>
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="card text-center">
                  <div class="card-body">
                    <img src="products/fashion.jpg" alt="" class="img-fluid rounded-circle">
                    <h3 class="card-title py-2">Fashion Products</h3>
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique odit consequatur architecto accusamus incidunt consequuntur maxime nemo rerum  </p>
                    <p class="socials">
                      <i class="bi bi-twitter text-dark mx-1"></i>
                      <i class="bi bi-facebook text-dark mx-1"></i>

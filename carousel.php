      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="products/p4.jpg" class="d-block w-100" alt="...">
          ...
          <div class="carousel-item">
            <img src="products/fashion.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption ">
              <h5>Fashion Products</h5>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum eum magni doloribus maxime fuga, consequatur itaque, dignissim.</p>
              <p> <a href="#" class="btn btn-warning mt-3">learn more</a></p>
            </div>
          </div>
          ...
          <div class="carousel-item">
            <img src="products/perfumes.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption ">
              <h5>Perfumes</h5>

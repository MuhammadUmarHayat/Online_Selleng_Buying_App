...
if ($data['password'] !== $data['retypePassword']) 
{
   die('Password and Confirm password should match!');   
	 ...
	 $name = $_POST['name'];
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////INSERT INTO `users`(`userid`, `email`, `password`, `name`, `mobile`, `address`, `userType`, `status`, `secrete_question`, `secrete_answer`) VALUES ('','','','','','','','','','')
...
<main>
            ...
            <form method="post" action="signupBuyar.php">
    <div class="center">
<table>
<tr> <td><h2> Buyer Registration </h2> </td> <td></td>   </tr>
